  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[400px] md:w-[500px] max-w-full relative rounded-3xl border border-b-0 flex-shrink-0 border-slate-700 px-10 py-8"
            style={{
              background:
          ...
          >
            <blockquote>
              ...
              ></div>
              <span className="relative z-20 text-base md:text-lg leading-[1.8] text-gray-100 font-normal">
                {item.quote}
              </span>
